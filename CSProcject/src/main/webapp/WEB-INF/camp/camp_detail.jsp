      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-10 posts-list">
              ...
              <div id="dialog" title="" v-if="rDetailShow" style="background-color: white;overflow: auto;">
              	<h3 style="margin-top: -10px;margin-bottom: 5px;">리뷰글</h3>
              	<div class="comment-form review-form" style="margin-top: -35px;border: none;">
                     <div class="row" >
                        <div class="col-sm-6">
                           <div class="form-group">
                              이름<input class="form-control" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" type="text" :value="review_detail.id" readonly>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="form-group">
                             작성날짜<input class="form-control" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" type="text" :value="review_detail.dbday" readonly>
                           </div>
                        </div>
                        <div class="col-12">
                           <div class="form-group">
                              제목<input class="form-control" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" type="text" :value="review_detail.subject" readonly>
                           </div>
                        </div>
                        <div class="col-12" v-if="review_detail.img!=' '">
                        캠프 이미지
                           <div class="form-group" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;width: 750px;height: 230px;display: grid;place-items: center">
	                           <img :src="review_detail.img" style="width: 300px;height: 200px;">
                           </div>
                        </div>	
                        <div class="col-12">
                           <div class="form-group">
                              내용<textarea class="form-control w-100" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" cols="30" rows="9" readonly>{{review_detail.content}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="row">
              ...
              <!-- 리뷰 수정 -->
              <div id="dialogU" v-if="rUpShow" title="" style="background-color: white;overflow: auto;">
                  ...
                  <form @submit.prevent="updateForm()">
                     <div class="row" >
                        <div class="col-sm-6">
                           <div class="form-group">
                              <input class="form-control" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" ref="id" type="text" :value="update_data.id" readonly>
                              <input type="hidden" ref="no" :value="update_data.no"> 
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="form-group">
                              <input class="form-control" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" ref="date" type="text" :value="update_data.dbday" readonly>
                           </div>
                        </div>
                        <div class="col-12">
                           <div class="form-group">
                              <input class="form-control" style="background-color: rgba(218, 192, 149,0.7);;font-weight: bold;"  ref=subject v-model=subject type="text">
                           </div>
                        </div>
                        <div class="col-12">
                           <div class="form-group">
                              <textarea class="form-control w-100" style="background-color: rgba(218, 192, 149,0.7);font-weight: bold;" ref=content v-model=content cols="30" rows="9">
                              	{{content}}
                              </textarea>
                           </div>
                        </div>
